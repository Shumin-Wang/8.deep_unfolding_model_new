...
if __name__ == '__main__':
    ...
    myChannel = MyFadingChannel.MyRacianFading(f, tx_antenna_gain, rx_antenna_gain, N_t, N_r, N_ris, K, 3,
                                               x_train_original[0, 0].numpy(), x_train_original[0, 1].numpy(),
                                               x_train_original[0, 2].numpy(), D, dist_ris)
    ...
    for epo in range(epoch):
        ...
        for x_train_batch, x_train_original_batch, U_batch, G1_batch, G2_batch in data_iter(batch_size, x_train,
                                                                                            x_train_original, U, G1, G2,
                                                                                            N_sample_train):
